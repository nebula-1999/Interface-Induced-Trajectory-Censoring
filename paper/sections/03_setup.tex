...
\textbf{A bound on the measurement itself.} The probe stores at most 4000 characters of
...
accordingly a \textbf{lower bound}, which is conservative for our claim: it can only
