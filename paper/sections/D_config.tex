...
This is a property of the training stack, not a proof that FC is irreparable in principle.
Forced tool choice through a rollout backend that exposes guided decoding remains untested,
and is the single experiment we would run next.
