...
Two controls fix what the effect is a property of. A $2\times2$ over chat template and parser
on a public benchmark finds \textbf{both main effects exactly zero}, with the entire
0.00-to-0.96 swing in their interaction: no component is defective, and repairing one side of
the contract buys nothing. And a ladder run under a \emph{matched} interface shows the silent
