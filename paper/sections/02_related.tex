...
\textbf{Tool-use benchmarks.} BFCL~\citep{bfcl2024}, $\tau$-bench (Yao et al.), ToolLLM~\citep{qin2024toolllm},
...
per-family configuration, which \S5.1 shows is not optional. verl~\citep{sheng2024hybridflow} provides the RL training stack; importantly its AgentLoop performs \textbf{its own}
